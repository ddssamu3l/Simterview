...
const Page = () => {
  return (
    <div className="flex flex-col items-center">
      {/* Hero Section */}
      <section
        className="card-cta w-full max-w-6xl px-4 py-16 sm:py-24"
      ...
      >
        <div className="flex flex-col gap-8 w-full items-center text-center sm:px-16">
          <h1 className="font-bold tracking-tight text-3xl sm:text-4xl md:text-5xl">
            Ace Your Software Engineering Interviews with AI-Powered Mock
            Interviews
          </h1>
          <p className="text-base sm:text-lg text-slate-300 max-w-2xl">
            Master technical coding challenges, data structures, algorithms, and
            behavioral questions with our intelligent AI interviewers. Get
            FAANG-ready and land your dream tech job!
          </p>
      ...
      {/* Features Section */}
      <section
        className="w-full border-t border-b py-16"
        aria-label="Interview Practice Features"
      >
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-2xl sm:text-3xl font-bold text-center mb-12">
            Why Would You Interview On Simterview
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="border hover:bg-dark-300 p-6 text-center">
              ...
              <p className="text-slate-400">
                Practice coding challenges, algorithms, and system design with
                intelligent AI interviewers that simulate real technical
            ...
            <div className="border hover:bg-dark-300 p-6 text-center">
              ...
              <p className="text-slate-400">
                Receive detailed assessments on your coding skills,
                problem-solving approach, and communication abilities to
            ...
            <div className="border hover:bg-dark-300 p-6 text-center">
              ...
              <p className="text-slate-400">
                Tailor practice sessions for frontend, backend, full-stack,
                machine learning, or other specialized software engineering
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div className="border p-6 hover:bg-dark-300">
              ...
              <ul className="list-disc pl-5 space-y-2 text-slate-300">
                ...
                <li>
                  Language-specific questions (Python, JavaScript, Java, C++)
                </li>
      ...
      <section className="w-full border-t py-16" aria-label="Get Started">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-slate-300 mb-8">
            Join thousands of developers who've improved their coding skills,
            technical knowledge, and behavioral interview responses with
            Simterview's AI-powered mock interviews
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Button
              asChild
              variant="outline"
              className="w-fit !bg-transparent !text-white hover:!bg-dark-300/90 !rounded-md !font-bold px-5 cursor-pointer min-h-10 border-2"
            >
          ...
          <div className="space-y-6">
            <div className="border p-6">
              <h3 className="font-bold text-xl mb-2">
                How do Simterview's mock interviews work?
              </h3>
              <p className="text-slate-300">
                Our AI-powered platform simulates real technical and behavioral
                interviews for software engineers. You'll interact with an
                intelligent interviewer that asks relevant coding challenges,
                algorithm questions, and behavioral scenarios, providing
            ...
            <div className="border p-6">
              <h3 className="font-bold text-xl mb-2">
                What types of coding questions can I practice?
              </h3>
              <p className="text-slate-300">
                Simterview covers a comprehensive range of technical questions
                including data structures, algorithms, system design, database
                concepts, and language-specific challenges in Python,
            ...
            <div className="border p-6">
              <h3 className="font-bold text-xl mb-2">
                How does Simterview prepare me for FAANG interviews?
              </h3>
              <p className="text-slate-300">
                Our platform models interview questions and formats used by top
                tech companies like Facebook, Amazon, Apple, Netflix, and
                Google. The difficulty levels and question styles are designed
                to match what you'll encounter in actual FAANG interviews.
              </p>
            </div>
          </div>
        </div>
